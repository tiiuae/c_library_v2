...
#define MAVLINK_MSG_ID_COMPONENT_INFORMATION_BASIC_CRC 45
#define MAVLINK_MSG_ID_396_CRC 45
...
#define MAVLINK_MESSAGE_INFO_COMPONENT_INFORMATION_BASIC { \
    ...
    {  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_component_information_basic_t, time_boot_ms) }, \
         ...
         { "component_cap_flags1", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_component_information_basic_t, component_cap_flags1) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_COMPONENT_INFORMATION_BASIC { \
 ...
 * @param component_cap_flags1  Component capability flags 1 (this is called 1, so that number 2 could be added in the future).
...
static inline uint16_t mavlink_msg_component_information_basic_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, const char *software_version, const char *hardware_version, uint64_t component_cap_flags1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_COMPONENT_INFORMATION_BASIC_LEN];
    _mav_put_uint64_t(buf, 0, component_cap_flags1);
    ...
    packet.component_cap_flags1 = component_cap_flags1;
...
{
    return mavlink_msg_component_information_basic_pack(system_id, component_id, msg, component_information_basic->time_boot_ms, component_information_basic->vendor_name, component_information_basic->model_name, component_information_basic->software_version, component_information_basic->hardware_version, component_information_basic->component_cap_flags1);
}
...
static inline void mavlink_msg_component_information_basic_send(mavlink_channel_t chan, uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, const char *software_version, const char *hardware_version, uint64_t component_cap_flags1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_COMPONENT_INFORMATION_BASIC_LEN];
    _mav_put_uint64_t(buf, 0, component_cap_flags1);
 ...
 */
static inline void mavlink_msg_component_information_basic_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, const char *software_version, const char *hardware_version, uint64_t component_cap_flags1)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field component_cap_flags1 from component_information_basic message
 *
 * @return  Component capability flags 1 (this is called 1, so that number 2 could be added in the future).
 */
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    component_information_basic->component_cap_flags1 = mavlink_msg_component_information_basic_get_component_cap_flags1(msg);
